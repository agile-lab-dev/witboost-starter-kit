...
| <img src="./docs/img/airflow.png" width="50">      | Tech Adapter | [MWAA Adapter](https://github.com/agile-lab-dev/witboost-mwaa-specific-provisioner)                                       | Scheduling - Airflow/MWAA                | Workload                  |                                                                                                                                      |
...
| <img src="./docs/img/snowflake.png" width="100">  | Workload     | [Snowflake SQL Workload](https://github.com/agile-lab-dev/witboost-snowflake-sql-workload-template)          | Data processing - Snowflake        | No Tech Adapter needed                                                                                                    | It's triggered by an orchestrator through the [MWAA Workload Template](https://github.com/agile-lab-dev/witboost-mwaa-workload-template) |
...
| <img src="./docs/img/airflow.png" width="60">     | Workload     | [MWAA Workload](https://github.com/agile-lab-dev/witboost-mwaa-workload-template)                            | Scheduling - Airflow/MWAA          | [MWAA Adapter](https://github.com/agile-lab-dev/witboost-mwaa-specific-provisioner)                                       |                                                                                                                                          |
